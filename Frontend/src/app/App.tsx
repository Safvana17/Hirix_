...
import ChangePassword from '../presentation/components/company/settings/ChangePassword'
...
import CandidateSnapshotsPage from '../presentation/components/company/test/CandidateSnapshotsPage'
       ...
       <Suspense fallback={
        ...
        <Routes>
         ...
         <Route path={ROUTES.COMPANY.RESTORE} element={<RestoreAccount />} />
          ...
          <Route path={ROUTES.COMPANY.CANCEL_TEST} element={
            <RoleRoute allowedRoles={[ROLES.COMPANY]}>
              <CancelTestPage />
            </RoleRoute>
          } />

          <Route path={ROUTES.COMPANY.RESHEDULE_TEST} element={
            <RoleRoute allowedRoles={[ROLES.COMPANY]}>
              <ResheduleTestPage />
            </RoleRoute>
          } />

          <Route path={ROUTES.COMPANY.TEST_DETAILS} element={
            <RoleRoute allowedRoles={[ROLES.COMPANY]}>
              <TestDetailsPage />
            </RoleRoute>
          } />
          ...
          <Route path={ROUTES.COMPANY.VIEW_SNAPSHOTS} element={
            <RoleRoute allowedRoles={[ROLES.COMPANY]}>
              <CandidateSnapshotsPage />
            </RoleRoute>
          } />
