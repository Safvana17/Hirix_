...
import { ICandidateMakePaymentUsecase } from "../../interfaces/subscription/ICandidate.makePayment.usecase";

export class CandidateMakePaymentUsecase implements ICandidateMakePaymentUsecase {
    constructor(
    ...
    async execute(request: CandidateMakePaymentInputDTO): Promise<CandidateMakePaymentOutputDTO> {
