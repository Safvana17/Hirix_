...
router.get(ROUTES.COMPANY.TEST.GET_SNAPSHOTS, authHandler(iTokenService), validate(ViewSnapshotSchema, 'params'), iCompanyTestController.viewSnapshots)
...
router.patch(ROUTES.COMPANY.INTERVIEW.SEND_OFFER, authHandler(iTokenService), verifyCsrf, validate(InterviewParamsSchema, 'params'), ICompanyInterviewController.sendOffer)
