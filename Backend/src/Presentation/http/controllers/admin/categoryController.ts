...
export class CategoryController {
    ...
    addCategory = asyncHandler(async (req: Request, res: Response): Promise<Response> => {
    ...
    getAllCategory = asyncHandler( async (req: Request, res: Response): Promise<Response> => {
    ...
    editCategory = asyncHandler( async (req: Request, res: Response): Promise<Response> => {
        const categoryId = Array.isArray(req.params.id)
              ? req.params.id[0]
              : req.params.id
