export const JobRoleMessages = {
    ...
    error: {
        ...
        INVALID_EXPERIENCE: 'Minimum experience must be less than maximum experience',
        JOBROLE_NOT_FOUND: 'Job Role is not found',
        EDIT_JOBROLE_FAILED: 'Failed to edit job role',
