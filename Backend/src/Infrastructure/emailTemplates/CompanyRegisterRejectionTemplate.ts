...
export const CompanyRegisterRejectionEmailTemplate = (companyName: string, reason: string, link: string) => `
<div style="
...
">
  <h2 style="color: #c0392b;text-align: center; margin-bottom: 20px;">
